...
[Script]
flow = type=generic,timeout=10,script-path=flow.js,script-update-interval=0,argument=url=[URL encode 后的机场节点链接]&reset_day=29&title=FlowerCloud&icon=bonjour&color=#007aff

[Panel]
flow = script-name=flow,update-interval=600
